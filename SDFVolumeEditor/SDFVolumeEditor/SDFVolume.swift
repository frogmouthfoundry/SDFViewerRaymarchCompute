...
final class SDFVolume {
    ...
    var volumeParams: VolumeParams {
        VolumeParams(
            ...
            voxelSizeX: voxelSize.x,
            voxelSizeY: voxelSize.y,
            voxelSizeZ: voxelSize.z,
            startPositionX: voxelStartPosition.x,
            startPositionY: voxelStartPosition.y,
            startPositionZ: voxelStartPosition.z,
            _pad0: 0
        )
    }
